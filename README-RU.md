...
Следуйте данной структуре, чтобы всё работало корректно и не запутаться

**_ideas** — Референсы  
**lua** — Скрипты Lua  
**maps** — Карты, .vmf файл для редактирования в Hammer++  
**materials** — Упакованные, используемые текстуры, материалы  
**materialsrc** — Распакованные текстуры, материалы  
**models** — Упакованные, используемые модели  
**modelsrc** — Распакованные модели  
**screenshots** — Скришноты разработчика  
